...
public class DryCleanInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dry_clean_info);
        ...
        btnBookNow.setOnClickListener(v -> {
            ...
            intent.putExtra("service_name",      "Dry Cleaning");
            intent.putExtra("service_subtitle",  "Professional deep cleaning.");
            intent.putExtra("service_image_res", R.drawable.img_dry_clean_new);
            startActivity(intent);
        });
    }
}
