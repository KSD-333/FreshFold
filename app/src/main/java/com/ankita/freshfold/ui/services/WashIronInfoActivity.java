...
public class WashIronInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wash_iron_info);
        ...
        btnBookNow.setOnClickListener(v -> {
            ...
            intent.putExtra("service_name",      "Wash & Iron");
            intent.putExtra("service_subtitle",  "Wash and iron together.");
            intent.putExtra("service_image_res", R.drawable.wash_iron);
            startActivity(intent);
        });
    }
}
