...
public class WashFoldInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wash_fold_info);
        ...
        btnBookNow.setOnClickListener(v -> {
            ...
            intent.putExtra("service_name",      "Wash & Fold");
            intent.putExtra("service_subtitle",  "Premium wash & fold service.");
            intent.putExtra("service_image_res", R.drawable.img_laundry_new);
            startActivity(intent);
        });
    }
}
