...
public class ShoeCareInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoe_care_info);
        ...
        btnBookNow.setOnClickListener(v -> {
            ...
            intent.putExtra("service_name",      "Shoe Care");
            intent.putExtra("service_subtitle",  "Shine & protect your shoes.");
            intent.putExtra("service_image_res", R.drawable.img_shoe_new);
            startActivity(intent);
        });
    }
}
